    ...
    return (
        <header className="fixed top-0 h-[80px] w-full py-[1rem] px-10 flex justify-between items-center z-30 duration-300">
            ...
            <nav className="flex gap-5">
                <Link className="border-2 border-green-500 px-5 py-2 rounded-xl font-bold tracking-[0.1rem] text-(--color-text-light) relative hover:bg-green-500 hover:shadow-emerald-300/50 shadow-2xl duration-150" href="/auth/login">
                    Login
                </Link>
