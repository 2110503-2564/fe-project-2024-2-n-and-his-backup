            ...
            <nav>
                {
                    session? (
                        /* --- Log out btn --- */
                        <Link className="flex border-2 border-green-500 px-5 py-2 rounded-xl font-bold tracking-[0.1rem] text-(--color-text-light) relative hover:bg-green-500 hover:shadow-emerald-300/50 shadow-2xl duration-150" href="/auth/logout">
                            <p>Log Out</p>
                        </Link>
                    ) : (
                        <div className="flex justify-center items-center flex-row gap-5">
                            {/* --- Log in btn --- */}
                            <Link className="bg-amber-800 px-5 py-2 rounded-xl font-bold tracking-[0.1rem] text-(--color-text-light) relative hover:bg-amber-500 hover:shadow-amber-500/50 shadow-2xl duration-150" href="/auth/login">
                                <p>Log In</p>
                            </Link>
